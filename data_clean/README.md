This repository contains all .csv files which have been produced during the study. 
...
These results are summarized in form of a table that shows the same results by quintile of wealth and geographical setting (urban/rural):
