...
GSEC4_2010 <- read_csv("Data_raw/Uganda/2010-2011/UGA_2010_UNPS_v02_M_CSV/socio/GSEC4.csv")     #GSEC4

# h4q4, h4q5, h4q7, h4q9
ind_educ10 <- select(GSEC4_2010, HHID, PID, h4q4, h4q5, h4q7, h4q9)
ind_educ10 <- mutate(ind_educ10,
                        id_hh = HHID,
                        id_ind = PID)
...
ind_educ10$ind_education["ind_school" == 1] = NA                                                         
...
#
clean_ind_edu10 <- ind_educ10[,c("id_hh", "id_ind", "ind_read", "ind_write", "ind_literacy", "ind_any_schooling", "ind_school", "ind_education", "ind_education_years")]


rm(GSEC4_2010, ind_educ10)

write_csv(clean_ind_edu10, "/Users/andreasalem/R_oba/Thesis/Data_clean/hh_educ2010.csv")
